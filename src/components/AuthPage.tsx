      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-3 border border-gray-600 dark:border-gray-600 border-gray-300 rounded-lg bg-gray-800 dark:bg-gray-800 bg-white text-white dark:text-white text-gray-900 hover:bg-gray-700 dark:hover:bg-gray-700 hover:bg-gray-50 transition-colors"
          >

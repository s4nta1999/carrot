      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-3 border border-gray-600 rounded-lg bg-white text-gray-900 hover:bg-gray-50 transition-colors"
          >
